...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        ...
        up = PhotoImage(Image.open(os.path.join(current_dir, '../img/up.png')).resize((13, 13)))
        right = PhotoImage(Image.open(os.path.join(current_dir, "../img/right.png")).resize((13, 13)))
        left = PhotoImage(Image.open(os.path.join(current_dir, "../img/left.png")).resize((13, 13)))
        down = PhotoImage(Image.open(os.path.join(current_dir, "../img/down.png")).resize((13, 13)))
        rectangle = PhotoImage(Image.open(os.path.join(current_dir, "../img/rectangle.png")).resize((65, 65)))
        triangle = PhotoImage(Image.open(os.path.join(current_dir, "../img/triangle.png")).resize((65, 65)))
        circle = PhotoImage(Image.open(os.path.join(current_dir, "../img/circle.png")).resize((65, 65)))
